...
sealed interface OutgoingVerificationViewEvent {
    ...
    data object StartEmailVerification : OutgoingVerificationViewEvent

    /** Ввели код и подтвердили. */
    data class SubmitEmailCode(val code: String) : OutgoingVerificationViewEvent

    /** Закрыли под-флоу почты. */
    data object DismissEmailVerification : OutgoingVerificationViewEvent
}
