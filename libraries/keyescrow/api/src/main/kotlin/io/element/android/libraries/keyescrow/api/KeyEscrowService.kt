...
interface KeyEscrowService {
    ...
    /**
     * Правка форка (решение юзера 2026-09-24): ключ восстановления для любой сессии, вошедшей в
     * аккаунт, без кода с почты — вход и есть подтверждение, как в Telegram. `null` — ключа нет
